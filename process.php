...
if (isset($_POST["submit"])) {
    ...
    $profile_image = mysqli_real_escape_string($conn, $_POST["profile_imag"]);
    $sqlInsert = "INSERT INTO products(product_name,product_type,profile_image) VALUES ('$productname','$producttype', '$profile_image')";
